...
CELERY_TASK_ROUTES = {
    ...
    "core.tasks.erms_sync_users_and_identities_task": {"queue": "celery"},
    "core.tasks.async_mail_admins": {"queue": "celery"},
    "core.tasks.async_mail_customer_care_admins": {"queue": "celery"},
    "core.tasks.fail_intentionally_task": {"queue": "celery"},
    ...
    "knowledgebase.tasks.update_platforms": {"queue": "celery"},
    "knowledgebase.tasks.update_report_types": {"queue": "celery"},
    "knowledgebase.tasks.update_parser_definitions": {"queue": "celery"},
    ...
    "logs.tasks.sync_interest_for_superseded_import_batches_task": {"queue": "interest"},
    "logs.tasks.process_one_import_batch_sync_log_task": {"queue": "celery"},
    "logs.tasks.unstuck_import_manual_upload_data": {"queue": "celery"},
    "logs.tasks.send_report_mailing_raw_task": {"queue": "celery"},
    ...
    "necronomicon.tasks.delete_batch_targets": {"queue": "celery"},
    "necronomicon.tasks.prepare_batch": {"queue": "celery"},
    "organizations.tasks.erms_sync_organizations_task": {"queue": "celery"},
...
CLICKHOUSE_EXPORT_MANUAL_COOLDOWN_HOURS = config(
    "CLICKHOUSE_EXPORT_MANUAL_COOLDOWN_HOURS", default=10, cast=int
)
