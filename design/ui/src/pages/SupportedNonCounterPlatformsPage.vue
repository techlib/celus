...
<script>
import SupportedNonCounterPlatformsList from "@/components/SupportedNonCounterPlatformsList";

export default {
  name: "SupportedNonCounterPlatformsPage",

  components: { SupportedNonCounterPlatformsList },
};
</script>
