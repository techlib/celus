        ...
        <v-card-text>
            ...
            >
                ...
                >
                    <td class="text-left">
                        <router-link
                                :to="{name: 'title-detail', params: {platformId: null, titleId: title.pk}}">
                            {{ title.name }}
                        </router-link>
                    </td>
                    <td class="text-right">{{ formatInteger(title.interests[interestGroup.short_name]) }}</td>
                </tr>
                </tbody>
            </v-simple-table>
            <div v-else-if="titles"> <!-- titles loaded, but no data -->
                <div class="mt-8 mb-2">
