...
@pytest.fixture
def counter_report_types(tr, dr, pr, ir_m1):
...
def targets():
    ...
    target2 = TitleFactory(name="target2", isbn="9781492084884", issn="", eissn="")
    target3 = TitleFactory(name="target3", isbn="", issn="", eissn="")
    return locals()
