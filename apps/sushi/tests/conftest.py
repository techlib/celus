...
def counter_report_type_named(report_type_nd):
    def fn(name):
        ...
        return CounterReportType.objects.create(code=name, counter_version=5, name=name + ' title',
                                                report_type=rt)
    yield fn
...
def counter_report_type(report_type_nd):
    ...
    yield CounterReportType.objects.create(code='TR', counter_version=5, name='Title report',
