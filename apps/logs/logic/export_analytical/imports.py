...
class PostgresqlImport(DbImport):
    ...
    COLS_TYPES = {
        ...
        "platform__counter_registry_id": "uuid",
        "target_id": "integer",
        "target__name": "text",
        ...
        "item_id": "integer",
        "item__name": "text",
        "item__publication_date": "date",
        "item__doi": "character varying(250)",
        "item__isbn": "character varying(20)",
        "item__eissn": "character varying(9)",
...
class ClickhouseImport(DbImport):
    ...
    COLS_TYPES = {
        ...
        "platform__counter_registry_id": "LowCardinality(String)",
        "target_id": "Int32",
        "target__name": "String",
